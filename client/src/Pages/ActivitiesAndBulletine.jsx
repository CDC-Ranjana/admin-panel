  ...
  return (
    <div className="container   px-4">
      ...
      <Modal
        ...
        className="bg-white p-6 rounded-lg shadow-xl w-[90%] max-w-lg mx-auto mt-10 mb-10 max-h-[400px] md:max-h-[500px] overflow-y-auto"
      ...
      {expandedItem && (
        <Modal
          ...
          className="bg-white p-6 pb-[70px] rounded-lg  shadow-xl w-[90%] max-w-4xl mx-auto my-10  h-full overflow-auto"
        ...
        {props.type === "recentActivities"
          ? recentActivities.map((activity, index) => (
              <div
                ...
                className="border cursor-pointer p-4 mb-4 rounded  flex-grow flex-shrink-0 min-w-[250px] max-w-[350px] w-full hover:shadow-lg transition-shadow duration-300"
                onClick={() =>
                  setExpandedItem({
